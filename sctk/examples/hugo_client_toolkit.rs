...
use smithay_client_toolkit::{
	...
	delegate_compositor, delegate_keyboard, delegate_output, delegate_pointer, delegate_registry, delegate_seat, delegate_shm, delegate_xdg_shell, delegate_touch, delegate_layer, delegate_xdg_window,
	output::{OutputHandler, OutputState},
	registry::{ProvidesRegistryState, RegistryState},
	seat::{
		keyboard::{KeyEvent, KeyboardHandler, Modifiers},
		pointer::{AxisKind, PointerHandler, PointerScroll},
		Capability, SeatHandler, SeatState, touch,
	},
	shell::xdg::{
		window,
	...
	shell::layer::{Anchor, LayerHandler, LayerState, LayerSurface, LayerSurfaceConfigure, LayerSurfaceBuilder}, shell::layer,
...
impl Hlib {
	...
	pub fn run(hclient: HClient) {
		...
		let layer =
			hlib.hclient.layer().map(&mut conn.handle(), &qh, &mut hlib.layer_state, surface, layer::Layer::Overlay)
